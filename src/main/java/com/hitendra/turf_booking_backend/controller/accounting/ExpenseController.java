...
@Tag(name = "Expenses", description = "Manage expenses (Admin only)")
...
public class ExpenseController {
    ...
    @PostMapping
    @Operation(summary = "Record an expense", description = "Create a new expense record and debit from cash ledger")
    ...
    @Operation(summary = "Get expenses by service", description = "Get all expenses for a service")
    ...
    @Operation(summary = "Get expenses by date range", description = "Get expenses for a service within a date range")
    ...
    @Operation(summary = "Get total expenses", description = "Get total expense amount for a service in a date range")
    ...
    @Operation(summary = "Get expense breakdown", description = "Get expense breakdown by category for a service")
