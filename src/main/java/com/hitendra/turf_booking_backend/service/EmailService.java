...
public class EmailService {
    ...
    /**
     * Send refund initiated notification email
     */
    public void sendRefundInitiatedEmail(String toEmail, String userName, RefundDetails refundDetails) {
        try {
            log.info("Sending refund initiated email to: {}", toEmail);

            String subject = "Refund Initiated - " + refundDetails.getBookingReference();
            String htmlBody = buildRefundEmailBody(userName, refundDetails);

            gmailService.sendEmail(toEmail, subject, htmlBody);

            log.info("Refund initiated email sent successfully to: {}", toEmail);

        } catch (Exception e) {
            log.error("Failed to send refund initiated email to: {}", toEmail, e);
            // Don't throw exception for email failure
        }
    }
                                        ...
                                        <table width="100%%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="margin:4px 0 0 0; font-size:15px; color:#111827; font-weight:500;">%s</p>
                                                </td>
                                            ...
                                            %s
                                            <tr>
                                                <td colspan="2" style="padding:16px 0 8px 0; border-top:1px solid #f3f4f6;">
                                                    <p style="margin:0; font-size:13px; color:#6b7280;">💰 Amount Breakdown</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:8px 0 0 0;">
                                                    <p style="margin:0; font-size:12px; color:#6b7280;">Total Amount</p>
                                                    <p style="margin:2px 0 0 0; font-size:14px; color:#111827; font-weight:500;">₹%s</p>
                                                </td>
                                                <td style="text-align:right; padding:8px 0 0 0;">
                                                    <p style="margin:0; font-size:12px; color:#6b7280;">Online Paid</p>
                                                    <p style="margin:2px 0 0 0; font-size:14px; color:#059669; font-weight:bold;">₹%s</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="padding:8px 0 0 0;">
                                                    <p style="margin:0; font-size:12px; color:#6b7280;">Due at Venue</p>
                                                    <p style="margin:2px 0 0 0; font-size:14px; color:#f59e0b; font-weight:600;">₹%s</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
    ...
    """.formatted(
            ...
            booking.getOnlineAmountPaid() != null ? String.format("%.2f", booking.getOnlineAmountPaid()) : String.format("%.2f", booking.getTotalAmount()),
            booking.getVenueAmountDue() != null ? String.format("%.2f", booking.getVenueAmountDue()) : "0.00",
    ...
    /**
     * Build refund initiated notification email body
     */
    private String buildRefundEmailBody(String userName, RefundDetails refund) {
        String displayName = userName != null && !userName.isEmpty() ? userName : "there";
            ...
            <tr>
                <td align="center" style="padding: 30px 0;">
                    <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:12px; box-shadow:0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <!-- Header -->
                        <tr>
                            <td style="background:linear-gradient(135deg, #3b82f6 0%%, #1d4ed8 100%%); padding:32px; text-align:center; border-radius:12px 12px 0 0;">
                                <div style="font-size:48px; margin-bottom:12px;">💰</div>
                                <h1 style="color:#ffffff; margin:0 0 8px 0; font-size:26px;">Refund Initiated!</h1>
                                <p style="color:#dbeafe; margin:0; font-size:15px;">Your refund has been successfully processed</p>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:0 32px 24px 32px;">
                                <div style="background:#eff6ff; border-left:4px solid #3b82f6; padding:16px 20px; border-radius:6px;">
                                    <p style="margin:0 0 6px 0; font-size:13px; color:#1e40af; font-weight:600;">BOOKING REFERENCE</p>
                                    <p style="margin:0; font-size:20px; color:#1e40af; font-weight:bold; letter-spacing:1px;">%s</p>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding:0 32px 24px 32px;">
                                <div style="border:1px solid #e5e7eb; border-radius:8px; overflow:hidden;">
                                    ...
                                    <!-- Header -->
                                    <div style="background:#f3f4f6; padding:16px; border-bottom:1px solid #e5e7eb;">
                                        <p style="margin:0; font-size:15px; color:#111827; font-weight:600;">Refund Details</p>
                                    </div>
                                        ...
                                        <table width="100%%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td colspan="2" style="padding:0 0 12px 0;">
                                                    <p style="margin:0; font-size:13px; color:#6b7280;">Refund Status</p>
                                                    <p style="margin:4px 0 0 0; font-size:15px; color:#059669; font-weight:bold;">%s</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding:12px 0;">
                                                    <p style="margin:0; font-size:13px; color:#6b7280;">Original Amount</p>
                                                    <p style="margin:4px 0 0 0; font-size:14px; color:#111827; font-weight:500;">₹%s</p>
                                                </td>
                                                <td style="text-align:right; padding:12px 0;">
                                                    <p style="margin:0; font-size:13px; color:#6b7280;">Refund Amount</p>
                                                    <p style="margin:4px 0 0 0; font-size:14px; color:#059669; font-weight:bold;">₹%s</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2" style="padding:12px 0 0 0; border-top:1px solid #f3f4f6;">
                                                    <p style="margin:0; font-size:13px; color:#6b7280;">Refund Policy</p>
                                                    <p style="margin:4px 0 0 0; font-size:14px; color:#111827; font-weight:500;">%s%% refund applied</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                        ...
                        <tr>
                            <td style="padding:0 32px 24px 32px;">
                                <div style="background:#f0fdf4; border-left:4px solid #10b981; padding:16px 20px; border-radius:6px;">
                                    <p style="margin:0 0 8px 0; font-size:14px; color:#166534; font-weight:600;">✓ What's Next?</p>
                                    <p style="margin:0; font-size:13px; color:#166534; line-height:1.6;">
                                        Your refund will be credited to your original payment method within 5-7 business days. 
                                        Check your bank account or digital wallet for the amount.
                                    </p>
                                </div>
                            </td>
                        </tr>
    ...
    """.formatted(
            displayName,
            refund.getBookingReference(),
            refund.getRefundStatus(),
            String.format("%.2f", refund.getOriginalAmount()),
    ...
    public static class BookingDetails {
        ...
        private Double venueAmountDue;
        private String location;
        private String contactNumber;
    }

    /**
     * DTO class for refund details
     */
    @lombok.Data
    @lombok.Builder
    @lombok.NoArgsConstructor
