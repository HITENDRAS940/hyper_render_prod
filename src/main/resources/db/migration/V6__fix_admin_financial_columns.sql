-- ============================================================================
-- Migration V6: Fix missing admin_profiles financial columns
--
-- V5 was recorded as SUCCESS in flyway_schema_history on some databases
-- before the ALTER TABLE statements actually executed (e.g. due to a
-- partial/interrupted migration). This migration is a safe, idempotent
-- catch-up that ensures all V5 columns exist.
--
-- All statements use IF NOT EXISTS / COALESCE so they are completely safe
-- to run on databases that already have the columns (no-op in that case).
-- ============================================================================
...
-- ─── 3. Apply NOT NULL + DEFAULT constraints ──────────────────────────────────
